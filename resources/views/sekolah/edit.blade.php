...
@section('content')
		...
		<div class="page-header page-header-light mb-3">
		  	<div class="page-header-content header-elements-md-inline">
		    	<div class="page-title d-flex">
		    		{{-- Breadcrumb tittle --}}
		      		<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Sekolah</span> - Edit data sekolah</h4>
		    	</div>
		  	</div>
		  	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		    	<div class="d-flex">
		      		<div class="breadcrumb">
		        		...
		        		<span class="breadcrumb-item active">Edit sekolah</span>
		      		</div>
		    	</div>
		  	</div>
		</div>
	...
	<div class="card">
		...
		<div class="card-body">
			<form action="{{ route('sekolah.update',$sekolah->sekolah_id) }}" method="post" enctype="multipart/form-data">
				@csrf
				{{ method_field('PUT') }}
