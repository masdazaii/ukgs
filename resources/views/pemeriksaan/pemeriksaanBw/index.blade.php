...
@section('content')
		  	...
		  	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		    	<div class="d-flex">
		      		<div class="breadcrumb">
		        		...
		        		<span class="breadcrumb-item active">Pemeriksaan Buta Warna</span>
		      		</div>
		    	</div>
		  	</div>
		</div>
	...
	<div class="card">
        <div class="card-header">
            <a type="button" href="{{ url('/soalButaWarna') }}" class="btn btn-primary">Soal Buta Warna</a>
        </div>
        <div class="card-body">
	...
	<script>
		$(document).ready(function() {
            $("#table").DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": {'url':"{{ url('pemeriksaan/5/pemeriksaanSekolahAjax') }}",
                        'headers':"{{ csrf_token() }}"},
                "order": ['0', 'desc'],
                "dataSrc": "data",
                "columns": [
